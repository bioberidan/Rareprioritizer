...
def create_output_path(data_type: str, orphacode: str, run_number: int) -> str:
    """Generate output path for disease processing result"""
    return f"data/preprocessing/{data_type}/{orphacode}/run{run_number}_disease2{data_type}.json"


def save_processing_result(data: dict, data_type: str, orphacode: str, run_number: int):
